...
@NgModule({
  ...
  providers: [SnackMessagePbService, SnackMessageService, InterviewDialogService, NewCandidateDialogService],
  entryComponents: [SnackMessageComponent, InterviewDialogComponent, NewCandidateDialogComponent],
  exports: [
    MaterialModule,
    ReusableMatConfirmModule,
    FlexLayoutModule,
